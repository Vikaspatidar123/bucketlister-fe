...
export default function ExplorePageComponent() {
    ...
    let pageDescription = "Discover curated travel packages and adventures. From Himalayan treks to international tours, find your perfect trip with THE BUCKETLISTER.";
    let pageKeywords = ['explore trips', 'travel packages', 'adventure tours', 'himalayan treks', 'international trips', 'vacation packages'];
