  ...
  const renderContent = (content) => {
    ...
    return sections.map((section, index) => {
      ...
      lines.forEach((line, lineIndex) => {
        if (line.startsWith('## ')) {
          sectionContent.push(
            <h2 key={`h2-${index}-${lineIndex}`} className={styles.sectionHeading}>
              {line.replace('## ', '')}
            </h2>
          );
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://thebucketlister.com/blogs/${post.slug}`} />
        <meta property="og:image" content={`https://thebucketlister.com${post.featuredImage}`} />
        <meta property="og:site_name" content="THE BUCKETLISTER" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={post.title} />
        <meta name="twitter:description" content={post.excerpt} />
        <meta name="twitter:image" content={`https://thebucketlister.com${post.featuredImage}`} />
        <link rel="canonical" href={`https://thebucketlister.com/blogs/${post.slug}`} />
            ...
            <aside className={styles.sidebar}>
              ...
              <div className={styles.ctaSection}>
                ...
                <p className={styles.ctaText}>
                  Turn your travel dreams into reality with THE BUCKETLISTER&apos;s curated experiences.
                </p>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.relatedGrid}>
              {relatedPosts.map(relatedPost => (
                <Link key={relatedPost.id} href={`/blogs/${relatedPost.slug}`} className={styles.relatedCard}>
                  ...
                  <div className={styles.relatedContent}>
                    ...
                    <div className={styles.relatedMeta}>
                      <span className={styles.relatedAuthor}>By {relatedPost.author}</span>
      ...
      <section className={styles.newsletterSection}>
        <div className={styles.container}>
          <div className={styles.newsletterCard}>
            <h2 className={styles.newsletterTitle}>Never Miss an Adventure</h2>
            <p className={styles.newsletterText}>
              Subscribe to our newsletter for the latest travel stories, destination guides, and exclusive offers.
            </p>
