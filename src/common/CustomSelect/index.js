...
const CustomSelect = ({
  ...
  const [selectedOption, setSelectedOption] = useState(!isMulti ? value : null);
  ...
  const updatePlacementAndSize = useCallback(
    throttle(() => {
  ...
  return (
    ...
    >
      ...
      >
        <span className={styles.displayValue}>{getDisplayValue()}</span>
