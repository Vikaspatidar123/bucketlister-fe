          ...
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.policyContent}>
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>Our cancellation policy varies based on destination categories. Please review the applicable section for your travel destination below.</p>
              </div>

              <div className={styles.contentBlock}>
                <h2 className={styles.sectionHeading}>2. Destination Categories</h2>
                ...
                <div className={styles.tableContainer}>
                  <table className={styles.dataTable}>
                    ...
                    <tbody>
                      <tr>
                        <td>Short Haul</td>
                        <td>Domestic India, Bhutan, Nepal, Sri Lanka, Thailand, Singapore, Bali, Dubai, Vietnam, Malaysia, Maldives, Mauritius</td>
                        <td>Standard cancellation terms</td>
                      </tr>
                      <tr>
                        <td>Long Haul</td>
                        <td>Europe, UK, USA, Canada, Japan, South Korea, Turkey, Egypt, Australia, New Zealand, South Africa, Kenya, South America</td>
              ...
              <div className={styles.contentBlock}>
                <h2 className={styles.sectionHeading}>3. Short Haul Cancellation Terms</h2>
              ...
              <div className={styles.contentBlock}>
                <h2 className={styles.sectionHeading}>4. Long Haul Cancellation Terms</h2>
              ...
              <div className={styles.contentBlock}>
                ...
                <div className={styles.subsection}>
                  ...
                  <ul className={styles.bulletList}>
                    ...
                    <li>Charges apply as per the policy communicated at booking</li>
                    <li>Credit notes may be issued instead of refunds</li>
                    <li>Processing timeframes will be communicated upon request</li>
                  </ul>
                </div>
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>For cancellation requests or questions about this policy:</p>
