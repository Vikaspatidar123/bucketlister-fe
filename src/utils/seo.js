export const DEFAULT_SEO = {
  ...
  description:
    "Discover curated travel experiences with THE BUCKETLISTER. From Himalayan treks to international adventures, find your perfect trip with small groups and expert guides.",
  keywords: [
    "travel",
    "adventure",
    "trekking",
    ...
    "adventure trip packages in india",
    "adventure holiday packages in india",
...
export const generateSEOTags = ({
  ...
  const seoTitle = cleanTitle
    ? `${cleanTitle} | ${DEFAULT_SEO.siteName}`
    : DEFAULT_SEO.title;
