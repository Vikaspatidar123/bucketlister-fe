          ...
          <div className={styles.contentWrapper}>
            ...
            <div className={styles.policyContent}>
              <div className={styles.contentBlock}>
                    ...
                    <table className={styles.dataTable}>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Passport info, preferences, dietary requirements
                          </td>
                        </tr>
                        <tr>
                ...
                <div className={styles.subsection}>
                  ...
                  <p className={styles.text}>
                    ...
                    experience, track website usage, and remember preferences.
                    These technologies assign random identifiers and do not
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>
                  The Bucketlister implements comprehensive security measures
                  including:
                </p>
                <ul className={styles.bulletList}>
                  <li>Encrypted data storage behind secure firewalls</li>
                  <li>
                    Password-protected database access with limited
                    authorization
                  </li>
                ...
                <div className={styles.warningBox}>
                  <p>
                    <strong>Important:</strong> While we maintain robust
                    security controls, no internet transmission or electronic
                    storage is completely secure. We cannot guarantee absolute
                    protection against unauthorized access during online
                    transfers.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>
                  We share personal information only in these specific
                  circumstances:
                </p>
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>
                  ...
                  external sites. Users should review the privacy policies of
              ...
              <div className={styles.contentBlock}>
                ...
                <p className={styles.text}>
                  ...
                  information collected will always be governed by the policy in
