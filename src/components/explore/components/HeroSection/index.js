...
const HeroSection = ({
  ...
  const limitedDescription = displayDescription
        ...
        >
          <div className={styles.heroOverlay}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroSubtitle}>{limitedDescription}</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <section className={styles.heroSection}>
      <div className={styles.heroContent}>
        ...
        <p className={styles.heroSubtitle}>
          International Escapes: curated journeys from Kyoto&apos;s temples to
          Tuscany&apos;s vineyards.
        </p>
      </div>
    </section>
